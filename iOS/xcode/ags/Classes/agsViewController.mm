...
{
    UIPanGestureRecognizer *panOneFinger = [[UIPanGestureRecognizer alloc]
        initWithTarget:self action:@selector(handlePanOneFinger:)];
    ...
    UISwipeGestureRecognizer* twoFingerSwipeUp = [[UISwipeGestureRecognizer alloc]
        initWithTarget:self action:@selector(handleTwoFingerSwipe:)];
    ...
    UISwipeGestureRecognizer* twoFingerSwipeDown = [[UISwipeGestureRecognizer alloc]
        initWithTarget:self action:@selector(handleTwoFingerSwipe:)];
